...
REM
REM Generated by Vivado on Sat May 16 20:26:01 +0700 2026
...
echo "xvlog --incr --relax -prj tb_sap_cpu_vlog.prj"
call xvlog  --incr --relax -prj tb_sap_cpu_vlog.prj -log xvlog.log
